			...
			foreach ( $product_addons as $addon ) {
				...
				switch ( $addon['type'] ) {
					...
					case 'file_upload':
						...
						break;
					case 'datepicker':
						include_once dirname( __FILE__ ) . '/fields/class-wc-product-addons-field-datepicker.php';
						$timestamp = isset( $_POST[ 'addon-' . $addon[ 'field_name' ] . '-wc-pao-date' ] ) ? absint( $_POST[ 'addon-' . $addon[ 'field_name' ] . '-wc-pao-date' ] ) : '';
						$offset    = isset( $_POST[ 'addon-' . $addon[ 'field_name' ] . '-wc-pao-date-gmt-offset' ] ) ? (float) $_POST[ 'addon-' . $addon[ 'field_name' ] . '-wc-pao-date-gmt-offset' ] : 0;
